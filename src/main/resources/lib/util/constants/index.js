module.exports = {
  default: {
    get contentType () { return 'application/json; charset=utf-8' },
    get headers () { return { 'Cache-Control': 'no-cache' } },
    get queryPathTemplate () { return '_path LIKE "/content/{{site}}/{{path}}"' },
    get sitePath () { return '/bookmark' },
    get unnamed () { return 'unnamed' },
    xDataName: String(app.name).split('.').join('-'),
    repository: 'no.seeds.bookmark'
  },
  shareList: {
  ...
  roles: {
    ...
    adminLogin: 'role:system.admin.login'
  },
  countryListEN: [{ id: 4, alpha2: 'af', alpha3: 'afg', name: 'Afghanistan' },
  ...
  countryListNO: [{ id: 4, alpha2: 'af', alpha3: 'afg', name: 'Afghanistan' },
    { id: 8, alpha2: 'al', alpha3: 'alb', name: 'Albania' },
    { id: 12, alpha2: 'dz', alpha3: 'dza', name: 'Algerie' },
    { id: 16, alpha2: 'as', alpha3: 'asm', name: 'Amerikansk Samoa' },
    { id: 20, alpha2: 'ad', alpha3: 'and', name: 'Andorra' },
    { id: 24, alpha2: 'ao', alpha3: 'ago', name: 'Angola' },
    { id: 660, alpha2: 'ai', alpha3: 'aia', name: 'Anguilla' },
    { id: 10, alpha2: 'aq', alpha3: 'ata', name: 'Antarktika' },
    { id: 28, alpha2: 'ag', alpha3: 'atg', name: 'Antigua og Barbuda' },
    { id: 32, alpha2: 'ar', alpha3: 'arg', name: 'Argentina' },
    { id: 51, alpha2: 'am', alpha3: 'arm', name: 'Armenia' },
    { id: 533, alpha2: 'aw', alpha3: 'abw', name: 'Aruba' },
    { id: 31, alpha2: 'az', alpha3: 'aze', name: 'Aserbajdsjan' },
    { id: 36, alpha2: 'au', alpha3: 'aus', name: 'Australia' },
    { id: 44, alpha2: 'bs', alpha3: 'bhs', name: 'Bahamas' },
    { id: 48, alpha2: 'bh', alpha3: 'bhr', name: 'Bahrain' },
    { id: 50, alpha2: 'bd', alpha3: 'bgd', name: 'Bangladesh' },
    { id: 52, alpha2: 'bb', alpha3: 'brb', name: 'Barbados' },
    { id: 56, alpha2: 'be', alpha3: 'bel', name: 'Belgia' },
    { id: 84, alpha2: 'bz', alpha3: 'blz', name: 'Belize' },
    { id: 204, alpha2: 'bj', alpha3: 'ben', name: 'Benin' },
    { id: 60, alpha2: 'bm', alpha3: 'bmu', name: 'Bermuda' },
    { id: 64, alpha2: 'bt', alpha3: 'btn', name: 'Bhutan' },
    { id: 68, alpha2: 'bo', alpha3: 'bol', name: 'Bolivia' },
    { id: 535, alpha2: 'bq', alpha3: 'bes', name: 'Bonaire, Sint Eustatius og Saba' },
    { id: 70, alpha2: 'ba', alpha3: 'bih', name: 'Bosnia-Hercegovina' },
    { id: 72, alpha2: 'bw', alpha3: 'bwa', name: 'Botswana' },
    { id: 74, alpha2: 'bv', alpha3: 'bvt', name: 'Bouvetøya' },
    ...
    { id: 108, alpha2: 'bi', alpha3: 'bdi', name: 'Burundi' },
    { id: 124, alpha2: 'ca', alpha3: 'can', name: 'Canada' },
    { id: 136, alpha2: 'ky', alpha3: 'cym', name: 'Caymanøyene' },
    { id: 152, alpha2: 'cl', alpha3: 'chl', name: 'Chile' },
    { id: 162, alpha2: 'cx', alpha3: 'cxr', name: 'Christmasøya' },
    { id: 170, alpha2: 'co', alpha3: 'col', name: 'Colombia' },
    { id: 184, alpha2: 'ck', alpha3: 'cok', name: 'Cookøyene' },
    { id: 188, alpha2: 'cr', alpha3: 'cri', name: 'Costa Rica' },
    { id: 192, alpha2: 'cu', alpha3: 'cub', name: 'Cuba' },
    { id: 531, alpha2: 'cw', alpha3: 'cuw', name: 'Curaçao' },
    { id: 208, alpha2: 'dk', alpha3: 'dnk', name: 'Danmark' },
    { id: 784, alpha2: 'ae', alpha3: 'are', name: 'De forente arabiske emirater' },
    { id: 260, alpha2: 'tf', alpha3: 'atf', name: 'De franske sørterritorier' },
    { id: 275, alpha2: 'ps', alpha3: 'pse', name: 'De palestinske territoriene' },
    { id: 214, alpha2: 'do', alpha3: 'dom', name: 'Den dominikanske republikk' },
    { id: 140, alpha2: 'cf', alpha3: 'caf', name: 'Den sentralafrikanske republikk' },
    { id: 86, alpha2: 'io', alpha3: 'iot', name: 'Det britiske territoriet i Indiahavet' },
    { id: 262, alpha2: 'dj', alpha3: 'dji', name: 'Djibouti' },
    { id: 212, alpha2: 'dm', alpha3: 'dma', name: 'Dominica' },
    { id: 218, alpha2: 'ec', alpha3: 'ecu', name: 'Ecuador' },
    { id: 818, alpha2: 'eg', alpha3: 'egy', name: 'Egypt' },
    { id: 226, alpha2: 'gq', alpha3: 'gnq', name: 'Ekvatorial-Guinea' },
    { id: 384, alpha2: 'ci', alpha3: 'civ', name: 'Elfenbenskysten' },
    { id: 222, alpha2: 'sv', alpha3: 'slv', name: 'El Salvador' },
    { id: 232, alpha2: 'er', alpha3: 'eri', name: 'Eritrea' },
    { id: 233, alpha2: 'ee', alpha3: 'est', name: 'Estland' },
    { id: 231, alpha2: 'et', alpha3: 'eth', name: 'Etiopia' },
    { id: 238, alpha2: 'fk', alpha3: 'flk', name: 'Falklandsøyene' },
    { id: 242, alpha2: 'fj', alpha3: 'fji', name: 'Fiji' },
    { id: 608, alpha2: 'ph', alpha3: 'phl', name: 'Filippinene' },
    { id: 246, alpha2: 'fi', alpha3: 'fin', name: 'Finland' },
    { id: 250, alpha2: 'fr', alpha3: 'fra', name: 'Frankrike' },
    { id: 254, alpha2: 'gf', alpha3: 'guf', name: 'Fransk Guyana' },
    { id: 258, alpha2: 'pf', alpha3: 'pyf', name: 'Fransk Polynesia' },
    { id: 234, alpha2: 'fo', alpha3: 'fro', name: 'Færøyene' },
    { id: 266, alpha2: 'ga', alpha3: 'gab', name: 'Gabon' },
    { id: 270, alpha2: 'gm', alpha3: 'gmb', name: 'Gambia' },
    { id: 268, alpha2: 'ge', alpha3: 'geo', name: 'Georgia' },
    { id: 288, alpha2: 'gh', alpha3: 'gha', name: 'Ghana' },
    { id: 292, alpha2: 'gi', alpha3: 'gib', name: 'Gibraltar' },
    { id: 308, alpha2: 'gd', alpha3: 'grd', name: 'Grenada' },
    { id: 304, alpha2: 'gl', alpha3: 'grl', name: 'Grønland' },
    { id: 312, alpha2: 'gp', alpha3: 'glp', name: 'Guadeloupe' },
    { id: 316, alpha2: 'gu', alpha3: 'gum', name: 'Guam' },
    { id: 320, alpha2: 'gt', alpha3: 'gtm', name: 'Guatemala' },
    { id: 831, alpha2: 'gg', alpha3: 'ggy', name: 'Guernsey' },
    ...
    { id: 328, alpha2: 'gy', alpha3: 'guy', name: 'Guyana' },
    { id: 332, alpha2: 'ht', alpha3: 'hti', name: 'Haiti' },
    { id: 334, alpha2: 'hm', alpha3: 'hmd', name: 'Heard- og McDonaldøyene' },
    { id: 300, alpha2: 'gr', alpha3: 'grc', name: 'Hellas' },
    { id: 340, alpha2: 'hn', alpha3: 'hnd', name: 'Honduras' },
    { id: 344, alpha2: 'hk', alpha3: 'hkg', name: 'Hongkong' },
    { id: 112, alpha2: 'by', alpha3: 'blr', name: 'Hviterussland' },
    { id: 356, alpha2: 'in', alpha3: 'ind', name: 'India' },
    { id: 360, alpha2: 'id', alpha3: 'idn', name: 'Indonesia' },
    ...
    { id: 832, alpha2: 'je', alpha3: 'jey', name: 'Jersey' },
    { id: 850, alpha2: 'vi', alpha3: 'vir', name: 'Jomfruøyene, De amerikanske' },
    { id: 92, alpha2: 'vg', alpha3: 'vgb', name: 'Jomfruøyene, De britiske' },
    { id: 400, alpha2: 'jo', alpha3: 'jor', name: 'Jordan' },
    { id: 116, alpha2: 'kh', alpha3: 'khm', name: 'Kambodsja' },
    { id: 120, alpha2: 'cm', alpha3: 'cmr', name: 'Kamerun' },
    { id: 132, alpha2: 'cv', alpha3: 'cpv', name: 'Kapp Verde' },
    { id: 398, alpha2: 'kz', alpha3: 'kaz', name: 'Kasakhstan' },
    { id: 404, alpha2: 'ke', alpha3: 'ken', name: 'Kenya' },
    { id: 156, alpha2: 'cn', alpha3: 'chn', name: 'Kina' },
    { id: 417, alpha2: 'kg', alpha3: 'kgz', name: 'Kirgisistan' },
    { id: 296, alpha2: 'ki', alpha3: 'kir', name: 'Kiribati' },
    { id: 166, alpha2: 'cc', alpha3: 'cck', name: 'Kokosøyene' },
    { id: 174, alpha2: 'km', alpha3: 'com', name: 'Komorene' },
    { id: 180, alpha2: 'cd', alpha3: 'cod', name: 'Kongo, Den demokratiske republikken' },
    { id: 178, alpha2: 'cg', alpha3: 'cog', name: 'Kongo, Republikken' },
    { id: 191, alpha2: 'hr', alpha3: 'hrv', name: 'Kroatia' },
    { id: 414, alpha2: 'kw', alpha3: 'kwt', name: 'Kuwait' },
    { id: 196, alpha2: 'cy', alpha3: 'cyp', name: 'Kypros' },
    ...
    { id: 807, alpha2: 'mk', alpha3: 'mkd', name: 'Makedonia, Republikken' },
    { id: 454, alpha2: 'mw', alpha3: 'mwi', name: 'Malawi' },
    { id: 458, alpha2: 'my', alpha3: 'mys', name: 'Malaysia' },
    { id: 462, alpha2: 'mv', alpha3: 'mdv', name: 'Maldivene' },
    { id: 466, alpha2: 'ml', alpha3: 'mli', name: 'Mali' },
    { id: 470, alpha2: 'mt', alpha3: 'mlt', name: 'Malta' },
    { id: 833, alpha2: 'im', alpha3: 'imn', name: 'Man' },
    { id: 504, alpha2: 'ma', alpha3: 'mar', name: 'Marokko' },
    { id: 584, alpha2: 'mh', alpha3: 'mhl', name: 'Marshalløyene' },
    { id: 474, alpha2: 'mq', alpha3: 'mtq', name: 'Martinique' },
    { id: 478, alpha2: 'mr', alpha3: 'mrt', name: 'Mauritania' },
    { id: 480, alpha2: 'mu', alpha3: 'mus', name: 'Mauritius' },
    { id: 175, alpha2: 'yt', alpha3: 'myt', name: 'Mayotte' },
    { id: 484, alpha2: 'mx', alpha3: 'mex', name: 'Mexico' },
    { id: 583, alpha2: 'fm', alpha3: 'fsm', name: 'Mikronesiaføderasjonen' },
    ...
    { id: 520, alpha2: 'nr', alpha3: 'nru', name: 'Nauru' },
    { id: 524, alpha2: 'np', alpha3: 'npl', name: 'Nepal' },
    { id: 528, alpha2: 'nl', alpha3: 'nld', name: 'Nederland' },
    { id: 554, alpha2: 'nz', alpha3: 'nzl', name: 'New Zealand' },
    { id: 558, alpha2: 'ni', alpha3: 'nic', name: 'Nicaragua' },
    { id: 562, alpha2: 'ne', alpha3: 'ner', name: 'Niger' },
    { id: 566, alpha2: 'ng', alpha3: 'nga', name: 'Nigeria' },
    { id: 570, alpha2: 'nu', alpha3: 'niu', name: 'Niue' },
    { id: 408, alpha2: 'kp', alpha3: 'prk', name: 'Nord-Korea' },
    { id: 580, alpha2: 'mp', alpha3: 'mnp', name: 'Nord-Marianene' },
    { id: 574, alpha2: 'nf', alpha3: 'nfk', name: 'Norfolkøya' },
    { id: 578, alpha2: 'no', alpha3: 'nor', name: 'Norge' },
    { id: 540, alpha2: 'nc', alpha3: 'ncl', name: 'Ny-Caledonia' },
    { id: 512, alpha2: 'om', alpha3: 'omn', name: 'Oman' },
    { id: 586, alpha2: 'pk', alpha3: 'pak', name: 'Pakistan' },
    { id: 585, alpha2: 'pw', alpha3: 'plw', name: 'Palau' },
    { id: 591, alpha2: 'pa', alpha3: 'pan', name: 'Panama' },
    { id: 598, alpha2: 'pg', alpha3: 'png', name: 'Papua Ny-Guinea' },
    { id: 600, alpha2: 'py', alpha3: 'pry', name: 'Paraguay' },
    { id: 604, alpha2: 'pe', alpha3: 'per', name: 'Peru' },
    { id: 612, alpha2: 'pn', alpha3: 'pcn', name: 'Pitcairnøyene' },
    ...
    { id: 646, alpha2: 'rw', alpha3: 'rwa', name: 'Rwanda' },
    { id: 652, alpha2: 'bl', alpha3: 'blm', name: 'Saint-Barthélemy' },
    { id: 654, alpha2: 'sh', alpha3: 'shn', name: 'St. Helena, Ascension og Tristan da Cunha' },
    { id: 659, alpha2: 'kn', alpha3: 'kna', name: 'Saint Kitts og Nevis' },
    { id: 662, alpha2: 'lc', alpha3: 'lca', name: 'Saint Lucia' },
    { id: 663, alpha2: 'mf', alpha3: 'maf', name: 'Saint-Martin' },
    { id: 666, alpha2: 'pm', alpha3: 'spm', name: 'Saint-Pierre og Miquelon' },
    { id: 670, alpha2: 'vc', alpha3: 'vct', name: 'Saint Vincent og Grenadinene' },
    { id: 90, alpha2: 'sb', alpha3: 'slb', name: 'Salomonøyene' },
    { id: 882, alpha2: 'ws', alpha3: 'wsm', name: 'Samoa' },
    { id: 674, alpha2: 'sm', alpha3: 'smr', name: 'San Marino' },
    { id: 678, alpha2: 'st', alpha3: 'stp', name: 'São Tomé og Príncipe' },
    { id: 682, alpha2: 'sa', alpha3: 'sau', name: 'Saudi-Arabia' },
    { id: 686, alpha2: 'sn', alpha3: 'sen', name: 'Senegal' },
    { id: 688, alpha2: 'rs', alpha3: 'srb', name: 'Serbia' },
    { id: 690, alpha2: 'sc', alpha3: 'syc', name: 'Seychellene' },
    { id: 694, alpha2: 'sl', alpha3: 'sle', name: 'Sierra Leone' },
    { id: 702, alpha2: 'sg', alpha3: 'sgp', name: 'Singapore' },
    ...
    { id: 705, alpha2: 'si', alpha3: 'svn', name: 'Slovenia' },
    { id: 706, alpha2: 'so', alpha3: 'som', name: 'Somalia' },
    { id: 724, alpha2: 'es', alpha3: 'esp', name: 'Spania' },
    { id: 144, alpha2: 'lk', alpha3: 'lka', name: 'Sri Lanka' },
    { id: 826, alpha2: 'gb', alpha3: 'gbr', name: 'Storbritannia' },
    { id: 729, alpha2: 'sd', alpha3: 'sdn', name: 'Sudan' },
    { id: 740, alpha2: 'sr', alpha3: 'sur', name: 'Surinam' },
    { id: 744, alpha2: 'sj', alpha3: 'sjm', name: 'Svalbard og Jan Mayen' },
    { id: 756, alpha2: 'ch', alpha3: 'che', name: 'Sveits' },
    { id: 752, alpha2: 'se', alpha3: 'swe', name: 'Sverige' },
    { id: 748, alpha2: 'sz', alpha3: 'swz', name: 'Eswatini' },
    { id: 760, alpha2: 'sy', alpha3: 'syr', name: 'Syria' },
    { id: 710, alpha2: 'za', alpha3: 'zaf', name: 'Sør-Afrika' },
    { id: 239, alpha2: 'gs', alpha3: 'sgs', name: 'Sør-Georgia og Sør-Sandwichøyene' },
    { id: 410, alpha2: 'kr', alpha3: 'kor', name: 'Sør-Korea' },
    { id: 728, alpha2: 'ss', alpha3: 'ssd', name: 'Sør-Sudan' },
    { id: 762, alpha2: 'tj', alpha3: 'tjk', name: 'Tadsjikistan' },
    ...
    { id: 772, alpha2: 'tk', alpha3: 'tkl', name: 'Tokelau' },
    { id: 776, alpha2: 'to', alpha3: 'ton', name: 'Tonga' },
    { id: 780, alpha2: 'tt', alpha3: 'tto', name: 'Trinidad og Tobago' },
    { id: 148, alpha2: 'td', alpha3: 'tcd', name: 'Tsjad' },
    { id: 203, alpha2: 'cz', alpha3: 'cze', name: 'Tsjekkia' },
    { id: 788, alpha2: 'tn', alpha3: 'tun', name: 'Tunisia' },
    { id: 795, alpha2: 'tm', alpha3: 'tkm', name: 'Turkmenistan' },
    { id: 796, alpha2: 'tc', alpha3: 'tca', name: 'Turks- og Caicosøyene' },
    { id: 798, alpha2: 'tv', alpha3: 'tuv', name: 'Tuvalu' },
    { id: 792, alpha2: 'tr', alpha3: 'tur', name: 'Tyrkia' },
    { id: 276, alpha2: 'de', alpha3: 'deu', name: 'Tyskland' },
    { id: 800, alpha2: 'ug', alpha3: 'uga', name: 'Uganda' },
    { id: 804, alpha2: 'ua', alpha3: 'ukr', name: 'Ukraina' },
    { id: 348, alpha2: 'hu', alpha3: 'hun', name: 'Ungarn' },
    { id: 858, alpha2: 'uy', alpha3: 'ury', name: 'Uruguay' },
    { id: 840, alpha2: 'us', alpha3: 'usa', name: 'USA' },
    { id: 581, alpha2: 'um', alpha3: 'umi', name: 'USAs ytre småøyer' },
    { id: 860, alpha2: 'uz', alpha3: 'uzb', name: 'Usbekistan' },
    { id: 548, alpha2: 'vu', alpha3: 'vut', name: 'Vanuatu' },
    { id: 336, alpha2: 'va', alpha3: 'vat', name: 'Vatikanstaten' },
    { id: 862, alpha2: 've', alpha3: 'ven', name: 'Venezuela' },
    { id: 732, alpha2: 'eh', alpha3: 'esh', name: 'Vest-Sahara' },
    { id: 704, alpha2: 'vn', alpha3: 'vnm', name: 'Vietnam' },
    { id: 876, alpha2: 'wf', alpha3: 'wlf', name: 'Wallis- og Futunaøyene' },
    { id: 894, alpha2: 'zm', alpha3: 'zmb', name: 'Zambia' },
    { id: 716, alpha2: 'zw', alpha3: 'zwe', name: 'Zimbabwe' },
    { id: 40, alpha2: 'at', alpha3: 'aut', name: 'Østerrike' },
    { id: 626, alpha2: 'tl', alpha3: 'tls', name: 'Øst-Timor' },
    { id: 248, alpha2: 'ax', alpha3: 'ala', name: 'Åland' }]

}

Object.freeze(module.exports.default)
